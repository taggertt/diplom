...
**Позитивные сценарии**
+ <br>Первичная оплата картой со статусом APPROVED<br>
  * В поле номер карты ввести номер карты 4444 4444 4444 4441 (соответствует APPROVED в файле data.json).<br>
