...
- **Для оплаты тура по дебетовой карте**
  ...
  + Вторичная отправка раннее использованных данных для оплаты дебетовой картой
    ...
    <br>**Ожидаемый результат:** Появется pop-up окно с текстом "Владелец данной карты уже оформлял покупку тура". В таблицах БД payment_entity, order_entity не должно появиться новых записей.<br>
